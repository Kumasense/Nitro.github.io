    ...
    <div class="container-fluid bg-white shadow pt-2 pb-2 mt-3">
        <center>
            ...
            <div class="text-center">
                <p class="text-dark mb-1">Copyright © 2024, All right reserved.</p>
                <small class="text-dark "><i class="fa-solid fa-cloud"></i>&nbsp;DINO <a href="https://www.facebook.com/2439CHdonut" class="text-dark">ติดต่อแอดมิน</a></small>
				</p>
        </center>
